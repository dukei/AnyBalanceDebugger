...
let AsyBalance = /** @class */ (() => {
    ...
    class AsyBalance {
        ...
        async api_retrieveCode(comment, image, options) {
            ...
            let _options = '';
            if (__classPrivateFieldGet(this, _global).api_stringified && options)
                _options = JSON.stringify(options);
            if (__classPrivateFieldGet(this, _global).api)
                return this.checkCallResponse(await __classPrivateFieldGet(this, _global).api.retrieveCode(comment, image, _options || options));
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.HTTP_METHOD = exports.OPTIONS = exports.RetrieveInputType = exports.AsyBalanceResultError = void 0;
